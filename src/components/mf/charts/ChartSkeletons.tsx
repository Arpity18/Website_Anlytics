...
export const DonutChartSkeleton: React.FC<{ height?: string }> = ({ height = "300px" }) => {
  return (
      ...
      <div className="grid grid-cols-2 h-full w-full gap-4">
        ...
        <div className="h-full w-full flex justify-center items-center">
          <div className="relative">
            <Skeleton className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full animate-pulse-slow" />
